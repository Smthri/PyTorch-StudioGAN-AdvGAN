...
class WORKER(object):
    def __init__(self, cfgs, run_name, Gen, Gen_mapping, Gen_synthesis, Dis, Gen_ema, Gen_ema_mapping, Gen_ema_synthesis,
                 ...
                 best_step, best_fid, best_ckpt_path, loss_list_dict, metric_list_dict, target_model, sr_module):
        self.cfgs = cfgs
        ...
        elif self.DATA.name == 'HE':
            self.num_eval = {'train': 18000, 'test': 4500}
        else:
            try:
    ...
    # -----------------------------------------------------------------------------
    def save_fake_images(self, png=True, npz=False):
        if self.global_rank == 0:
